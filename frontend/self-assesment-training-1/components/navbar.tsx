            ...
            <div className={` fixed z-20 top-0 left-0 w-80 bg-white shadow-3xl h-screen p-8 text-black ${isSidebarOpen?"translate-x-0":"-translate-x-100"} transition-all`}>
                        ...
                        <ul className="flex flex-col items-start mt-20  text-md font-medium gap-6">
                            <li className="flex items-center gap-3">
                                <Image src={"/media_files/icons/icon-pin.svg"} alt="Pin icon" width={20} height={20}/>
                                <Link href={"#regional-guide"}>Regional Guide</Link>
                            </li>
                            <li className="flex items-center gap-3">
                                <Image src={"/media_files/icons/icon-utensils.svg"} alt="Utensil icon" width={20} height={20}/>
                                <Link href={"#experiences"}>Experience</Link>
                            </li>
                            <li className="flex items-center gap-3">
                                <Image src={"/media_files/icons/icon-globe.svg"} alt="GLobe icon" width={20} height={20}/>
                                <Link href={"#practical-information"}>Practical Information</Link>
                            </li>
                            <li className="flex items-center gap-3">
                                <Image src={"/media_files/icons/icon-landmark.svg"} alt="Landmark icon" width={20} height={20}/>
                                <Link href={"#essential-information"}>Essential Information</Link>
                            </li>
                            <li className="flex items-center gap-3">
                                <Image src={"/media_files/icons/icon-accommodation.svg"} alt="Accomodation icon" width={20} height={20}/>
                                <Link href={"#contact"}>Contact</Link>
                            </li>
                        </ul>
