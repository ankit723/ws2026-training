...
export default async function Page() {
    ...
    const deleteProduct = async(gtin: bigint) => {
        ...
        revalidatePath("/03_module_b/products")
    }

    return (
        <div className="w-screen h-screen flex flex-col p-20 bg-slate-300 gap-3">
            <div className="w-full flex justify-center ">
                <Link href={`/03_module_b/product/new`} className="col-span-1 bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 cursor-pointer">New</Link>
            </div>
